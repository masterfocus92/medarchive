...
>
> **Обновление 15.07.2026 — кит v2 (этап 5.5) — утверждено владельцем 15.07.2026.** Поведение, сортировки и маршруты не меняются; меняется визуальный слой:
...
> поток страниц карточки — блок `page-flow` **внутри `rec-body`** (карточка — единый «лист»; имя `.pages` в ките v2 занято превью-списком формы добавления).
